...
For this lab we will start with the binary deployment option (#2 above), uploading the code directly from the workspace to OpenShift.
For this to work, we will need the `oc` client working in our local machine.
