...
We are comparing the *item* attribute of the object Order and print a message.
...
One way to do it is by using a `Processor`. With a `Processor`, you can have total control of the message and headers being sent through the Camel pipeline.
