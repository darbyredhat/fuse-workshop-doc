...
. Add this repository to your walkthrough catalog
    ...
    oc patch webapp tutorial-web-app --type=merge -o yaml -p '{ "spec": { "template": { "parameters": { "WALKTHROUGH_LOCATIONS": "https://github.com/integr8ly/tutorial-web-app-walkthroughs.git#master,https://github.com/GuilhermeCamposo/fuse-workshop-doc.git#master" }}}}' -n webapp
